			...
			<div class="d-flex flex-column flex-column-fluid">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
					...
					<div class="pt-lg-10 mb-10">
						<!--begin::Logo-->
						<h1 class="fw-bolder fs-2qx text-gray-800 mb-7">Kích hoạt tài khoản</h1>
						<!--end::Logo-->
						<!--begin::Message-->
						<div class="fs-3 fw-bold text-muted mb-10">Chúng tôi đã gửi link kích hoạt về địa chỉ email của bạn</div>
						...
						<!--begin::Action-->
						<div class="fs-5">
							<span class="fw-bold text-gray-700">Không nhận được mã xác nhận?</span>
							<a href="../../demo8/dist/authentication/flows/basic/sign-up.html" class="link-primary fw-bolder">Gửi lại</a>
						</div>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
