                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end align-items-center" data-kt-posts-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary btn-add" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_post">
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="d-flex justify-content-end align-items-center d-none"
                                data-kt-posts-table-toolbar="selected">
                                    ...
                                    <th class="w-10px pe-2">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                data-kt-check-target="#kt_posts_table .form-check-input" value="1" />
                                        </div>
                                    </th>
                                    <th class="min-w-80px">Ảnh</th>
                                    <th class="min-w-300px">Bài viết</th>
