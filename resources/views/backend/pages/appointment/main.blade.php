...
@section('title', 'Quản lý đặt lịch khám')

@section('breadcrumb')
    <div class="page-title d-flex flex-column me-5">
        <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Quản lý đặt lịch khám</h1>
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
            ...
            <li class="breadcrumb-item text-dark">Quản lý đặt lịch khám</li>
        </ul>
    </div>
@endsection
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container">
                    ...
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-appointments-table-filter="search"
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end align-items-center"
                                data-kt-appointments-table-toolbar="base">
                                <!-- Date Filter -->
                            ...
                            <div class="d-flex justify-content-end align-items-center d-none"
                                data-kt-appointments-table-toolbar="selected">
                                <div class="fw-bolder me-5">
                                    <span class="me-2" data-kt-appointments-table-select="selected_count"></span>
                                    đã chọn
                                </div>
                                <button type="button" class="btn btn-danger"
                                    data-kt-appointments-table-select="delete_selected">
                                    Xóa các mục đã chọn
                                </button>
                            </div>
                        </div>
                ...
                @include('backend.pages.appointment.modal')
            </div>
        </div>
    </div>
@endsection
...
@push('jscustom')
    ...
    @include('backend.pages.appointment.js')
@endpush

@push('csscustom')
    <style>
        /* Custom styles for appointments management */
        .container {
            max-width: 100%;
            margin: 0 auto;
        }
